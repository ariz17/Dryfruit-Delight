        ...
        <div className="p-5 space-y-4 text-xs">
          ...
          <form onSubmit={handleSubscribe} className="space-y-3.5">
            ...
            <button
              type="submit"
              disabled={subscribed}
              className="w-full font-bold text-xs py-2.5 rounded-lg transition shadow-xs flex items-center justify-center gap-1.5 bg-zinc-900 hover:bg-black text-white dark:bg-white dark:text-black dark:hover:bg-zinc-200"
            >
              {subscribed ? (
                <>
